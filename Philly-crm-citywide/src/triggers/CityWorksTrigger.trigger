    ...
    // not a delete  
        ...
        if (Trigger.isBefore)  {   
         ...
         //  if(Trigger.isInsert )    {
                ...
                // Change Contact Object to List<Object>, as the line was throwing exception if there is no 'ANON ANON'
                List<Contact> newCon =[Select id, Name from Contact where name = 'ANON ANON' LIMIT 1];
                ...
                for(Case cs:Trigger.new) {      
                   ...
                   */
                   ...
                   if(cs.Type == 'Service Request Type' && (cs.Department__c == 'Streets Department' || cs.Department__c == 'Water Department (PWD)'))    {                      
                   ...
                   // Support Ticket #09506122, added condition to link 'Anon Anon' contact only to Service Request Cases not for Information request Type ticket
                   else if(cs.Type == 'Service Request Type' && (cs.Department__c == 'License & Inspections') || (cs.Department__c == 'Community Life Improvement Program' && cs.Case_Record_Type__c == 'Vacant Lot Clean-Up' ))   {
                       ...
                       //Fix For Support Ticket #08993566 
                        if(cs.contactId == null && userInfo.getUserType() == 'Standard' )  {
                            ...
                            if(newCon != null && newCon.size() == 1)

                                cs.contactId = newCon[0].id;
                        }
